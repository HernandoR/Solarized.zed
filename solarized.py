...
# Emitted as JSONC (Zed parses theme files leniently) with a header comment so
# the generated file announces its origin. Edit solarized.py, not this output.
_HEADER = (
